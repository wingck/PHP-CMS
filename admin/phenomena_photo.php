...
if( isset( $_FILES['photo'] ) )
{
  ...
  set_message( 'UFO natural phenomena photo has been updated' );
...
if( isset( $_GET['id'] ) )
{
  ...
  if( isset( $_GET['delete'] ) )
  {
    ...
    set_message( 'UFO natural phenomena photo has been deleted' );
...
<h2>Edit UFO Natural Phenomena Photo</h2>
...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="phenomena_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
...
<p><a href="phenomena.php"><i class="fas fa-arrow-circle-left"></i> Return to UFO Natural Penomena List</a></p>
