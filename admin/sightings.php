...
<div class="grid-container">
  ...
  <?php while( $record = mysqli_fetch_assoc( $result ) ): ?>
      ...
      <div class="grid-icon grid-border">
          ...
          <a href="sightings.php?delete=<?php echo $record['id']; ?>" onclick="javascript:if(confirm('Are you sure you want to delete this sighting?')==true){return true;} else {return false;};"><i class="fa-solid fa-trash ficon"></i></a>
      </div>
  <?php endwhile; ?>
  </div>
