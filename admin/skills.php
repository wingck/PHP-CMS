...
<table>
  ...
  <?php while( $record = mysqli_fetch_assoc( $result ) ): ?>
    <tr>
      ...
      <td align="center"><a href="skills_edit.php?id=<?php echo $record['id']; ?>">Edit</i><br><br><a href="skills_edit.php?id=<?php echo $record['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a><br><br>
        <a href="skills.php?delete=<?php echo $record['id']; ?>" onclick="javascript:confirm('Are you sure you want to delete this skill?');"><i class="fa-solid fa-trash"></i></a>
      </td>
