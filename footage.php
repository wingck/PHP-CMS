...
<div class="grid-container-2">
  ...
  <?php while( $record = mysqli_fetch_assoc( $result ) ): ?>
    ...
    <div class="grid-icon-2 grid-border-2">
      ...
      <a href="footage.php?delete=<?php echo $record['id']; ?>" onclick="javascript:confirm('Are you sure you want to delete this footage?');"><i class="fa-solid fa-trash ficon2"></i></a>
    </div>
  <?php endwhile; ?>
</div>
