...
<div class="grid-container-3">
  ...
  <div class="grid-icon-3 grid-border-3">
    ...
    <a href="phenomena.php?delete=<?php echo $record['id']; ?>" onclick="javascript:confirm('Are you sure you want to delete this natural phenomena?');"><i class="fa-solid fa-trash ficon3"></i></a>
  </div>
  <?php endwhile; ?>
</div>
